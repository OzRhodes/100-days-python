# start with ascii art for HANGMAN
# guess a letter - take a guess from the user
# display ____________ plus any correct letters
# display the gallows builing with the victim withn increasing number of body parts
